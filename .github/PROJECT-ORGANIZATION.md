...
<!-- Placeholders: 13-vscode-tools = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 13-vscode-tools - Organization Standards
